        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">MALE</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        <a href="Payment(AZZAK).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(male1).jpg">AZZAK MANSION<br>9000TK(per month)</button>
                        </a>
                        <a href="Payment(PARAJ).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(male2).jpg">PARAJ VILA<br>8000TK(per month)</button>
                        </a>
                        <a href="Payment(manshah).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(male3).jpg">MANSHAH VILA<br>10000TK(per month)</button>
                        </a>
                        <a href="payment(mitsan).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(male4).jpg">MITSAN BHABAN<br>9000TK(per month)</button>
                        </a>
                        <a href="Payment(ataur).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(male5).jpg">ATAUR MANSION<br>10000TK(per month)</button>
                        </a>
                        <a href="Payment(anwar).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(male6).jpg">ANWAR VILA<br>8000TK(per month)</button>
                        </a>
                    </div>
                </div>
            </div>
