        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">PAYMENT FOR RENTAL CONFIRMATION(MITSAN BHABAN)</h1>
                    </center>
                </div>
                        ...
                        <form action="payment(mitsan).php" method="post" target="votar">
                            <center>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            Payment for confirmation(3000TK)
                                        </td>
                                        <td>
                                            <input required class="form-control" name="payment" id="payment" value="3000" placeholder="Enter payment for confirmation">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            House owner bkash number(018632479456)
                                        </td>
                                        <td>
                                            <input required class="form-control" name="bkash" id="bkash" value="018632479456" placeholder="Enter the house owner bkash number">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('SAVEmitsan.php')" class="btn btn-priamary" name="submitButton" type="submit" value="CONFIRM RENT">
                                        </td>
                                    </tr>
                                </table>
                            </center>
