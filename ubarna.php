        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">PAYMENT FOR RENTAL CONFIRMATION(UBARNA MANSION)</h1>
                    </center>
                </div>
                        ...
                        <form action="Payment(ubarna).php" method="post" target="votar">
                            <center>
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            House owner bkash number(0189632478)
                                        </td>
                                        <td>
                                            <input required class="form-control" name="bkash" id="bkash" value="0189632478" placeholder="Enter the house owner bkash number">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('SAVEubarna.php')" class="btn btn-priamary" name="submitButton" type="submit" value="CONFIRM RENT">
                                        </td>
                                    </tr>
                                </table>
                            </center>
