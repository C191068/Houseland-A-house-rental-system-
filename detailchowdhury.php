        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">Detail of Chowdhury</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                            ...
                            <button>
                                <img style="height:300px;width:70%;" src="bedbachelor.jpeg">8<br>BEDROOM</button>
                       
                        
                        <button>
                            <img style="height:300px;width:70%;" src="bath.jpeg">4<br>Drawing room</button>
                        
                        
                        <button>
                            <img style="height:300px;width:70%;" src="dining.jpeg">4<br>Dining room</button>
                       
                        
                            <button>
                            <img style="height:300px;width:70%;" src="kitchen.jpeg">4<br>Kitchen</button>
                       
                        
                            <button>
                            <img style="height:300px;width:70%;" src="bath.jpeg">8<br>Bathroom</button>
