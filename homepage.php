    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12 badge-priamary" style="min-height: 500px">
            <div class="card">
                ...
                <div class="row">
                        <div class="column">
                            <a href="login.php" target="_blank"><button><img height="50" width="50" src="icon.jpeg">SIGN IN</button></a>
                        </div>
                        <div class="column">
                            <a href="adminlogin.php" target="_blank"><button><img height="50" width="50" src="icon.jpeg">ADMIN SIGN IN</button></a>
                        </div>
                    </div>
            </div>
            <div>
