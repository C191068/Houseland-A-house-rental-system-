        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">FEMALE</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        <a href="Payment(kari).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(female1).jpg">KARI MANSION<br>9000TK(per month)</button>
                        </a>
                        <a href="Payment(abana).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(female2).jpg">ABANA Prasad<br>8000TK(per month)</button>
                        </a>
                        <a href="Payment(obita).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(female3).jpg">OBITA VILA<br>9000TK(per month)</button>
                        </a>
                        <a href="Payment(anjita).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(female4).jpg">ANJITA BHABAN<br>8000TK(per month)</button>
                        </a>
                        <a href="Payment(ubarna).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(female5).jpg">UBARNA MANSION<br>7000TK(per month)</button>
                        </a>
                        <a href="Payment(abnhaz).php">
                            <button>
                                <img style="height:300px;width:70%;" src="bachelor(female6).jpg">ABNHAZ VILA<br>9000TK(per month)</button>
                        </a>
                    </div>
                </div>
            </div>
