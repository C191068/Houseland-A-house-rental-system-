            ...
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <div class="scrolling-wrapper">
                        ...
                        $insert_query="INSERT INTO sharif(customername,mobile,email,payment,bkash) values('$customername','$mobile','$email','$payment','$bkash')";
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <tr>
                                ...
                                <td>
                                    House owner bkash number(01726544128)
                                </td>
