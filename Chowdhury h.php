        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <a href="owner.php">
                    <button>
                        <img height="50" width="50" src="icon.jpeg">ALI & KHATAMI CHOWDHURY(owner)</button>
                    </a>
                    <a href="detailchowdhury.php">
                        <button>
                            <img height="50" width="50" src="icon.jpeg">VIEW HOUSE DETAIL</button>
                    </a>
            ...
            <div>
                <center>
                    <img style="height:300px;width:70%;" src="quadplex-1.jpeg">
                </center>
            </div>
            <div>
                <center>
                    <a href="Chowdhury.php">
                        <button class="btn btn-priamary"><img height="50" width="50" src="irent.jpeg">RENT NOW</button>
                    </a>
                </center>
            </div>
