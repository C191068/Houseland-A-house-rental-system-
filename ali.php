        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-success">
                    <center>
                        <h1 style="color:yellow;font-size:40px;">ALI CHOWDHURY</h1>
                    </center>
                </div>
                <div class="card-body badge-warning">
                    <center>
                        <img style="width:30%;height:200px;" src="ali.jpg">
                    </center>
                </div>
            </div>
            <center>
                <table>
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">MOBILE NO:0187456321</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">EMAIL:ali67@gmail.com</h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
