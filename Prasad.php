        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                <div class="card-header bg-primary">
                    <center>
                        <h1 style="color:red;font-size:40px;">PAYMENT FOR RENTAL CONFIRMATION(PRASAD)</h1>
                    </center>
                </div>
...
<td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input required class="form-control" name="bkash" id="bkash" value="0179634456" placeholder="Enter the house owner bkash number">
                                        </td>
<td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input onclick="window.open('SAVEPrasad.php')" class="btn btn-priamary" name="submitButton" type="submit" value="CONFIRM RENT">
                                        </td>
                                    </tr>
                                </table>
                            </center>
