        ...
        <div class="col-md-12 col-lg-12 col-sm-12 badge-warning" style="min-height: 500px">
            <div class="card">
                ...
                <div class="card-body badge-warning">
                    <center>
                    <img style="width:30%;height:200px;" src="<?php echo $_SESSION['picture'];?>">
                    </center>
                </div>
            </div>
            <center>
                ...
                <h1 style="color:red;font-size:40px;">MOBILE NO:<?php echo $_SESSION['mobile'];?></h1>
                    ...
                    <tr>
                        ...
                        <td>
                            <h1 style="color:red;font-size:40px;">MEMBERS:<?php echo $_SESSION['members'];?></h1>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                    <td>
                        <a onclick="confirm('Do you want to log out??')" class="btn btn-primary" href="logout.php">LOG OUT</a>
                    </td>
                    </tr>
